...
**Current state: M0–M10 complete; M11 in progress (M11.1–M11.3 done).** A playable vertical slice (RC1) — main menu, hub, gate, a
...
attack is a three-hit chain on it since M11.2, and the heavy attack a second chain since M11.3.
Everything visible is a **placeholder**: definitive art production starts at M13.

Next: **M11 — Combat System 2.0**, from M11.4 (M11.1–M11.3 are complete). See
