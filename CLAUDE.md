...
**Current state: M0–M10 complete; M11 in progress (M11.1 and M11.2 done).** A playable vertical slice (RC1) — main menu, hub, gate, a
...
scenes. The player's combat runs on its own controller (`PlayerCombat`) since M11.1, and the light
attack is a three-hit chain on it since M11.2. Everything visible is a **placeholder**: definitive art
production starts at M13.

Next: **M11 — Combat System 2.0**, from M11.3 (M11.1 and M11.2 are complete). See
