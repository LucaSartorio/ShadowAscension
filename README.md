...
machine and a target owner), M12.2 (the melee archetype — a telegraphed swing as data) and M12.3 (the
ranged archetype — distance kept, a telegraphed projectile) are done; the phase runs to Alpha 1 at M20.
